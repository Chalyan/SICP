...
(test-group "'Recursive function' pbt tests in range from -10 to 3(not included)"
...
(test-group "'Recursive function' pbt tests in range from 3 to 10"
...
(test-group "'Recursive function' pbt tests for negative integers starting from -9"
...
(test-group "'Recursive function' pbt tests for positive integers starting from 1"
    (test-generative ((the-number (lambda () (+ 1 (pseudo-random-integer 9)))))
